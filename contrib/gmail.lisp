...
;;;
;;; Created: Пятница, Февраль  8 2013
;;;
;;;
;;;
...
(defvar *gmail-username* *credentials/gmail-username*
  "Username for gmail")
(defvar *gmail-password* *credentials/gmail-password*
  "Password for gmail")
...
(defparameter *gmail-ping-period* (* 30 internal-time-units-per-second)
